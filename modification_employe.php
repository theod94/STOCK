        ...
        <div class="col-10 mx-auto">
            <div class="panel panel-default mx-auto">
                ...
                <form class="formulaire_references mt-5 mb-5 p-3 col-md-3 mx-auto" method="POST" action="">
                    <div class="">
                        <label class="col-4 pl-0" for="">Nom : </label>
                        ...
                        <label class="col-4 pl-0" for="">Email : </label>
                        ...
                        <input class="col-7" type="password" name="password" placeholder="" value="">
                        <label class="col-4 pl-0" for="">Statut : </label>
