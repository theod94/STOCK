...
class Carousel {
  ...
  // quand click sur photo accueil pop-up s'ouvre pour login

  setClickPopin(){
    galleryItems.forEach(control => {
      control.addEventListener('click', () => {

        if (control.classList.contains('gallery-item-selected')) {
            openModal();
        }
...
exampleCarousel.setClickPopin();


// popup //

// let btnPopup = document.querySelector('.gallery-item-selected');
